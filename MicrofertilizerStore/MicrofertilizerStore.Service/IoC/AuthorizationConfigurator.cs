...
namespace MicrofertilizerStore.Service.IoC
{
    ...
    {
        public static void ConfigureServices(this IServiceCollection services, MicrofertilizerStoreSettings settings)
        {
            ...
            services.AddIdentity<UserEntity, UserRoleEntity>(options =>
            {
                ...
                .AddEntityFrameworkStores<MicrofertilizerStoreDbContext>()
