...
namespace MicrofertilizerStore.DataAccess
{
    ...
    {
        public Repository(IDbContextFactory<MicrofertilizerStoreDbContext> contextFactory)
        {
        ...
        private readonly IDbContextFactory<MicrofertilizerStoreDbContext> _contextFactory;
    }
}